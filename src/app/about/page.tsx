...
export const metadata: Metadata = {
  title: "About - Age Calculator & Date Tools | agecalculator.one",
  description: "Learn about agecalculator.one, a free suite of online age and date calculation tools. All tools run 100% in your browser for complete privacy.",
  alternates: { canonical: "https://agecalculator.one/about" },
};

export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl sm:text-4xl font-bold text-text dark:text-text-dark mb-6">About agecalculator.one</h1>

      <div className="card mb-8">
        <div className="prose prose-sm max-w-none text-muted dark:text-text-dark-muted space-y-4">
          <p>
            agecalculator.one is a free, privacy-first suite of online date and time calculation tools.
          ...
          <p>
            ...
            compromises on privacy. Every tool on agecalculator.one runs entirely in your web browser.
          ...
          <p>
            agecalculator.one is built with modern web technologies including Next.js, TypeScript, and
